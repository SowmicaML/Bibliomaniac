...
if(isset($_GET['delete']) && $_GET['delete'] != ''){
  $id = $_GET['delete'];
  $de_sql = "DELETE FROM books WHERE id='$id'";
...
if(isset($_GET['activate']) && $_GET['activate'] != ''){
  ...
  $id = $_GET['id'];
  $de_sql = "UPDATE books SET status='$status' WHERE id='$id'";
  $de_result = mysqli_query($conn, $de_sql);
...
<body class="">
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">View Book Details</h4>
              </div>
              <div class="card-body">
                  ...
                  <table class="table">
                    ...
                    do {
                      ...
                      <tr>
                        ...
                        <td>
                          <img src="<?php echo "../uploads/".$row[14]; ?>" style="width: 15%;">
                        </td>
                        <td>
                          <?php if($row[15] == "1"){ ?>
                            <a onclick="confirm_activate('<?php echo $row[0]; ?>','0')">Active</a>
                          <?php }else{ ?>
                            <a onclick="confirm_activate('<?php echo $row[0]; ?>','1')">Blocked</a>
                          <?php } ?>
                        </td>
                        <td>
  ...
  <script>
      function confirmm(id)
      {
          ...
          if(log==true)
          {
              location.href="books.php?delete="+id;
          }
      }
